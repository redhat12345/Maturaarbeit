...
def format_image(img_path, size):
    ...
    # Following line: Slice image to center around face (only needed when just the center square is wanted)
...
if __name__ == '__main__':
    ...
    parser.add_argument('jpeg_dir', type=str) #path to images
