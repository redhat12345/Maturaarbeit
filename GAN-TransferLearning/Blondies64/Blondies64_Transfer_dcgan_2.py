...
# Get hdf5 file
hdf5_file = os.path.join("PATH TO DATASET", "Blondies_Transfer_64.h5")
...
#make the first layers unchangeable
for l in generator.layers[:8]:
    l.trainable = False

for l in discriminator.layers[:8]:
    l.trainable = False
